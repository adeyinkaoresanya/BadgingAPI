...
const dbConnect = require("./shared/database/helpers/dbconnect.js");
const {setUpEventRoutes} = require("./event-badging/routes/event-badging.route.js");
const {setUpAuthRoutes} = require("./shared/routes/auth.shared.route.js");
